        ...
        <section className="bg-navy-900 min-h-screen pt-32 pb-20 px-4">
            ...
            <div className="max-w-5xl mx-auto space-y-6">
                {servicesList.map((service, index) => (
                    <div key={index} className="glass p-6 md:p-8 rounded-xl border border-slate-700 flex flex-col md:flex-row items-center gap-6 md:gap-8 hover:border-gold-400/30 transition-all duration-300 group hover:-translate-y-1">

                        {/* Icon */}
                        <div className="w-16 h-16 bg-navy-800 rounded-lg flex-shrink-0 flex items-center justify-center text-gold-400 text-2xl shadow-lg shadow-black/20 group-hover:scale-110 transition-transform">
                            <i className={`fas ${service.icon}`}></i>
                        </div>

                        {/* Content */}
                        <div className="flex-grow text-center md:text-left">
                            <h3 className="text-xl font-bold text-white mb-2 group-hover:text-gold-400 transition-colors">{service.title}</h3>
                        ...
                        {/* Price & Action */}
                        <div className="flex-shrink-0 flex flex-col items-center md:items-end min-w-[180px]">
                            ...
                            <a
                                ...
                                className="w-full md:w-auto px-8 py-3 border border-gold-400 text-gold-400 rounded-lg text-center font-bold hover:bg-gold-400 hover:text-navy-900 transition-all duration-300 uppercase tracking-wider text-sm"
                            >
                                Purchase Now
                            </a>
                        </div>
