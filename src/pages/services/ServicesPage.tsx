      ...
      services: [
        {
          ...
          link: "/services/hidden-job-market"
        },
        {
              ...
              {category.services.map((service, sIndex) => {
                  ...
                  <div className="flex items-start gap-4 h-full">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white mb-2 group-hover:text-gold-400 transition-colors">
                        {service.title}
                        {service.link && <i className="fas fa-arrow-right ml-2 text-xs opacity-0 group-hover:opacity-100 transition-opacity transform translate-x-1"></i>}
                      </h3>
                ...
                return service.link ? (
                  <Link
                    key={sIndex}
                    to={service.link}
                    className="glass p-6 rounded-xl hover:bg-navy-800 transition duration-300 group hover:-translate-y-1 border border-transparent hover:border-gold-400/30 block cursor-pointer"
                  >
                    <CardContent />
                  </Link>
                ) : (
                  <div
                    key={sIndex}
                    className="glass p-6 rounded-xl hover:bg-navy-800 transition duration-300 group border border-transparent"
                  >
                    <CardContent />
                  </div>
                );
